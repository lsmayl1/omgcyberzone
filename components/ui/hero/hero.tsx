        ...
        <div className="absolute items-center justify-center w-full flex flex-col h-full  ">
          <div className="flex  container-custom   flex-col  text-white gap-14  max-md:gap-6 ">
            ...
            <div className="flex gap-4 items-center  max-md:items-start">
              ...
              />
              <button className="uppercase px-8 py-4 border-white border rounded-xl text-lg font-semibold text-nowrap max-md:text-sm  max-md:px-4 max-md:py-1 max-md:rounded transition-transform duration-300 hover:scale-105">
                Посмотреть игры
              </button>
            </div>
